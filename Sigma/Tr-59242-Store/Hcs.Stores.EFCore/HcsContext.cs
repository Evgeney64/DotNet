...
namespace Hcs.Stores
{
    public partial class HcsContext : DbContext
    {
        ...
        public virtual DbSet<SysTransactionParam> SysTransactionParam { get; set; }
        ...
        //    {
        //        entity.HasIndex(e => new { e.TransactionGUID, e.ParamName })
        //            .HasName("IX_SysTransactionParam")
        //            .IsUnique();
        ...
        //        entity.HasOne(d => d.TransactionGU)
        //            .WithMany(p => p.SysTransactionParams)
        //            .HasForeignKey(d => d.TransactionGUID)
        //            .OnDelete(DeleteBehavior.ClientSetNull)
        //            .HasConstraintName("FK_SysTransactionParam_SysTransaction");
        //    });
