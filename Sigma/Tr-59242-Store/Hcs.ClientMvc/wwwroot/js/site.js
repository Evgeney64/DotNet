            ...
            items: [
                {
                    ...
                    handler: function () {
                        ...
                        $(panel.getComponent('takeData')).css('visibility', 'hidden');
                        Ext.Ajax.request({
                            url: 'Home/TestStore',
                    ...
                    xtype: 'button',
                    text: 'Выполнить (TestStorePostgres)',
                    id: 'takeDataP',
                    height: 30,
                    width: 450,
                    margin: '5 0 0 5',
                    ...
                    handler: function () {
                        ...
                        //execute.css('visibility', 'hidden;');
                        //execute.css('visibility', 'collapse');
                        $(panel.getComponent('takeDataP')).css('visibility', 'hidden');
                        Ext.Ajax.request({
                            url: 'Home/TestStoreP',
                            success: function (response, options) {
                                if (response != null) {
