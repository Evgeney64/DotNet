...
namespace Server.Core.Model
{
    ...
    public partial class NSI_METER : IEntityObject, IEntityLog
    {
        ...
        // 
        // FK_NSI_METER_NSI_FACTORY   [NSI_FACTORY.NFACTORY_ID]
        [ForeignKey("NFACTORY_ID")]
        public virtual NSI_FACTORY NSI_FACTORY { get; set; }//;
        // 
        // FK_NSI_METER_NSI_PRODUCT   [NSI_PRODUCT.NPRODUCT_ID]
        [ForeignKey("NPRODUCT_ID")]
        public virtual NSI_PRODUCT NSI_PRODUCT { get; set; }//;
        #endregion
        #region Navigation - children
        // 
        // FK_EQUIPMENT_METER_NSI_METER   [EQUIPMENT_METER.NMETER_ID]
        public virtual ICollection<EQUIPMENT_METER> EQUIPMENT_METER { get; set; }//;
        // 
        // FK_NSI_METER_CONFIG_NSI_METER   [NSI_METER_CONFIG.NMETER_ID]
        public virtual ICollection<NSI_METER_CONFIG> NSI_METER_CONFIG { get; set; }//;
        // 
        // FK_NSI_METER_PARAM_NSI_METER   [NSI_METER_PARAM.NMETER_ID]
