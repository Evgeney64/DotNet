...
namespace Server.Core.Model
{
    ...
    public partial class NSI_DISTRICT : IEntityObject
    {
        ...
        // 
        // FK_NSI_DISTRICT_NSI_DISTRICT1   [NSI_DISTRICT.NDISTRICT_ID]   #1
        [ForeignKey("PARENT_ID")]
        public virtual NSI_DISTRICT NSI_DISTRICT1 { get; set; }//;
        // 
        // FK_NSI_DISTRICT_NSI_DISTRICT   [PARTNER.PARTNER_ID]
        [ForeignKey("PARTNER_ID")]
        public virtual PARTNER PARTNER { get; set; }//;
        #endregion
        #region Navigation - children
        // 
        // FK_NSI_DISTRICT_NSI_DISTRICT1   [NSI_DISTRICT.PARENT_ID]   #2
