...
namespace Server.Core.Model
{
    ...
    public partial class NSI_MUNICIPALITY_TYPE : IEntityObject, IEntityLog
    {
        ...
        // 
        // FK_NSI_MUNICIPALITY_NSI_MUNICIPALITY_TYPE   [NSI_MUNICIPALITY.NMUNICIPALITY_TYPE_ID]
        public virtual ICollection<NSI_MUNICIPALITY> NSI_MUNICIPALITY { get; set; }//;
        // 
        // FK_NSI_VILLAGE_NSI_MUNICIPALITY_TYPE   [NSI_VILLAGE.NMUNICIPALITY_TYPE_ID]
