...
namespace Server.Core.Model
{
    ...
    public partial class NSI_EVENT : IEntityObject, IEntityLog
    {
        ...
        // 
        // FK_NSI_EVENT_NSI_CONTACT   [NSI_CONTACT.NCONTACT_ID]
        [ForeignKey("NCONTACT_ID")]
        public virtual NSI_CONTACT NSI_CONTACT { get; set; }//;
        #endregion
        #region Navigation - children
        // 
        // FK_EVENT_NSI_EVENT1   [EVENT.NINFO_TRANSFER_ID]
        public virtual ICollection<EVENT> EVENT { get; set; }//;
        // 
        // FK_EVENT_NSI_EVENT   [EVENT.NEVENT_ID]   #1
        public virtual ICollection<EVENT> EVENT1 { get; set; }//;
        // 
        // FK_TASK_EVENT_TRIGGER_NSI_EVENT   [TASK_TRIGGER_EVENT.NEVENT_ID]
