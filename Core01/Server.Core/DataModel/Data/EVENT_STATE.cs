...
namespace Server.Core.Model
{
    ...
    public partial class EVENT_STATE : IEntityObject, IEntityLog
    {
        ...
        // 
        // FK_EVENT_STATE_DEAL   [DEAL.DEAL_ID]
        [ForeignKey("DEAL_ID")]
        public virtual DEAL DEAL { get; set; }//;
        // 
        // FK_EVENT_STATE_DOCUMENT   [DOCUMENT.DOCUMENT_ID]
        [ForeignKey("DOCUMENT_ID")]
        public virtual DOCUMENT DOCUMENT { get; set; }//;
        // 
        // FK_EVENT_STATE_DOCUMENT_ITEM   [DOCUMENT_ITEM.DOCUMENT_ITEM_ID]
        [ForeignKey("DOCUMENT_ITEM_ID")]
        public virtual DOCUMENT_ITEM DOCUMENT_ITEM { get; set; }//;
        // 
        // FK_EVENT_STATE_EVENT   [EVENT.EVENT_ID]
        [ForeignKey("EVENT_ID")]
        public virtual EVENT EVENT { get; set; }//;
        // 
        // FK_EVENT_STATE_FACILITY   [FACILITY.FACILITY_ID]
        [ForeignKey("FACILITY_ID")]
        public virtual FACILITY FACILITY { get; set; }//;
        // 
        // FK_DOCUMENT_ACTION_STATE_NSI_ACTION_STATE   [NSI_EVENT_STATE.NEVENT_STATE_ID]
        [ForeignKey("NEVENT_STATE_ID")]
        public virtual NSI_EVENT_STATE NSI_EVENT_STATE { get; set; }//;
        // 
        // FK_EVENT_STATE_NSI_REAZON   [NSI_REAZON.NREAZON_ID]
        [ForeignKey("NREAZON_ID")]
        public virtual NSI_REAZON NSI_REAZON { get; set; }//;
        // 
        // FK_EVENT_STATE_PARTNER   [PARTNER.PARTNER_ID]
