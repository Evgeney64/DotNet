...
declare function entity_ReadData_EditableGrid(sender, grid_items): void;
declare function getRowId_ByGuid(page_guid): string;
declare function Top(): any;
declare function addToUrl(url: string, key: string, val): string;
declare function updateQueryStringParameter(uri: string, key: string, value): string;
